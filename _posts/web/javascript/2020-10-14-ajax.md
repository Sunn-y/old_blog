...
아작스? 애이작스? 아잭스? 바다 건너에서는 애이잭스라고 읽음<br>

## Ajax란 웹을 새로고침하지 않고 데이터를 보내거나 받아오는 웹개발 기술

> "Ajax is merely a web development technique used<br>
> in order to send and retrieve data in the background<br>
> without refreshing a web page."<br>
